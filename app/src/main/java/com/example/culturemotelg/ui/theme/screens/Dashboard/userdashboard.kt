...
@Composable
fun ClientScreen(navController: NavController, clientViewModel: ClientViewModel = androidx.lifecycle.viewmodel.compose.viewModel()) {
    ...
    Scaffold(
        ...
        Column(modifier = Modifier.padding(innerPadding)) {
            ...
            Spacer(modifier = Modifier.height(10.dp))
            Button( onClick = { navController.navigate("culture_rooms") },
                modifier = Modifier.fillMaxWidth() ) { Text("Go to Culture Rooms") }
        }
    }
}
